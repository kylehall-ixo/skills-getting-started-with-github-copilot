...
activities = {
    ...
    "Tennis Club": {
        "description": "Learn and practice tennis with experienced coaches",
    ...
    "Art Studio": {
        "description": "Explore painting, sculpting, and other visual arts",
    ...
    "Debate Club": {
        ...
        "max_participants": 16,
        "participants": ["thomas@mergington.edu", "lucy@mergington.edu"]
    },
    "Science Club": {
